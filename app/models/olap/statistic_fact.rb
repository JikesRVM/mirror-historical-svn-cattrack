...
#
class Olap::StatisticFact < ActiveRecord::Base
  validates_presence_of :host_id, :time_id, :revision_id, :test_run_id, :build_target_id, :build_configuration_id, :test_configuration_id, :test_case_id, :result_id, :statistic_id, :value 
  ...
  belongs_to :statistic, :class_name => 'Olap::StatisticDimension', :foreign_key => 'statistic_id'
