...
class RoutingTest < Test::Unit::TestCase
  def test_routes
    ...
    assert_routing('/results/excalibur.watson.ibm.com/core/36/statistics_report', :host_name => 'excalibur.watson.ibm.com', :test_run_variant => 'core', :test_run_id => '36', :controller => 'results/test_run', :action => 'statistics_report')
