...
class RoutingTest < Test::Unit::TestCase
  def test_routes
    assert_routing('/results/excalibur.watson.ibm.com/core.36/production/Measure_Compilation_Opt_0/SPECjvm98/_200.check/Output.txt', :host_name => 'excalibur.watson.ibm.com', :test_run_variant => 'core', :test_run_id => '36', :build_configuration_name => 'production', :test_configuration_name => 'Measure_Compilation_Opt_0', :group_name => 'SPECjvm98', :test_case_name => '_200.check', :controller => 'results/test_case', :action => 'show_output')
    assert_routing('/results/excalibur.watson.ibm.com/core.36/production/Measure_Compilation_Opt_0/SPECjvm98/_200_check/Output.txt', :host_name => 'excalibur.watson.ibm.com', :test_run_variant => 'core', :test_run_id => '36', :build_configuration_name => 'production', :test_configuration_name => 'Measure_Compilation_Opt_0', :group_name => 'SPECjvm98', :test_case_name => '_200_check', :controller => 'results/test_case', :action => 'show_output')
