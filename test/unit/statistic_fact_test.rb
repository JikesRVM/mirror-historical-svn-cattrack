...
class StatisticFactTest < Test::Unit::TestCase
  ...
  def self.attributes_for_new
    {:host_id => 1, :build_configuration_id => 1, :build_target_id => 1, :test_case_id => 1, :time_id => 1, :revision_id => 1, :source_id => 1, :value => 23}
  end
  def self.non_null_attributes
    [:host_id, :build_configuration_id, :build_target_id, :test_case_id, :time_id, :revision_id, :value]
  end
