...
ActionController::Routing::Routes.draw do |map|
  ...
  map.connect 'results/:host_name/:test_run_variant.:test_run_id/:build_configuration_name/:test_configuration_name/:group_name/:test_case_name/:test_case_result_name/Output.txt', :controller => 'results/test_case_result', :action => 'show', :conditions => {:method => :get}
