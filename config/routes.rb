...
ActionController::Routing::Routes.draw do |map|
  ...
  map.connect 'results/:host_name/:test_run_variant/:test_run_id/:build_configuration_name/:test_configuration_name/:group_name/:test_case_name/history', :controller => 'results/test_case', :action => 'show_history', :conditions => {:method => :get}
