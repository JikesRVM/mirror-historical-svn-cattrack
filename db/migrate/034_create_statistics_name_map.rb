...
class CreateStatisticsNameMap < ActiveRecord::Migration
  ...
  def self.up
    ...
    add_index :statistics_name_map, [:group_name, :test_case_name, :key], :unique => true
    add_index :statistics_name_map, [:group_name]
    add_index :statistics_name_map, [:test_case_name]
    add_index :statistics_name_map, [:key]

    [
    ['SPECjbb2005','SPECjbb2005','score',false,'SPECjbb2005'],
    ['SPECjbb2000','SPECjbb2000','score',false,'SPECjbb2000'],
    ['SPECjvm98','SPECjvm98','aggregate.best.score',false,'SPECjvm98'],
    ...
    ['CaffeineMark','Sieve.run2','time',false,'CaffeineMark: Sieve'],
    ['CaffeineMark','Loop.run2','time',false,'CaffeineMark: Loop'],
    ['CaffeineMark','Logic.run2','time',false,'CaffeineMark: Logic'],
    ['CaffeineMark','String.run2','time',false,'CaffeineMark: String'],
    ['CaffeineMark','Float.run2','time',false,'CaffeineMark: Float'],
    ['CaffeineMark','Method.run2','time',false,'CaffeineMark: Method'],
    ['ipsixql','Ipsixql','time',false,'Ipsixql'],
    ...
    ['jBYTEmark','jBYTEmark','FP.index',false,'jBYTEmark: FP'],
      ...
      StatisticsNameMap.create!(:group_name => r[0], :test_case_name => r[1], :key => r[2], :less_is_more => r[3], :label => r[4])
    end
  end
